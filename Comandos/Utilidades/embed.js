...
module.exports = {
    ...
    run: async(client, interaction) => {
      ...
      if (!interaction.member.permissions.has(Discord.PermissionFlagsBits.ManageMessages))
        ...
        .setColor(`${CorEmbed}`)
        .setAuthor({ name: 'Mutant Whats', iconURL: 'https://media.discordapp.net/attachments/1058071506317488168/1058082237184225450/discord_bot.png?width=683&height=683' })
        .setTitle(`${TítuloEmbed}`)
        .setDescription(`${DescriçãoEmbed}`)
        .setTimestamp()
        .setFooter({ text: 'Mutant Whats', iconURL: 'https://media.discordapp.net/attachments/1058071506317488168/1058082237184225450/discord_bot.png?width=683&height=683' })
